...
export const LandingPage: React.FC = () => {
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/public-metrics`)
      .then(res => res.json())
      .then(data => {
  ...
  const handleQuickVerify = (e: React.FormEvent) => {
    ...
    if (clean) {
      navigate(`/verify-certificate/${encodeURIComponent(clean)}`);
    } else {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased selection:bg-blue-900 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all">
        <div className="w-full max-w-[1560px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 gap-3 lg:gap-5">
            ...
            >
              <div className="w-10 h-10 bg-blue-900 text-white rounded-xl flex items-center justify-center shadow-md ring-2 ring-blue-900/20 flex-shrink-0 group-hover:scale-105 transition-transform">
              ...
              <div className="flex flex-col justify-center">
                ...
                <span className="text-[12px] sm:text-[13px] font-black text-blue-900 tracking-tight leading-none whitespace-nowrap mt-0.5">
            ...
            <nav className="hidden 2xl:flex items-center justify-center gap-1.5 flex-1 px-1">
              <button
                onClick={() => scrollToSection('#hero')}
                className="text-xs font-bold uppercase tracking-wider text-slate-600 hover:text-blue-900 hover:bg-slate-100/80 px-2.5 py-1.5 rounded-lg transition-colors whitespace-nowrap"
              >
                Home
              </button>
              <button
            ...
            <div className="flex items-center space-x-2 sm:space-x-2.5 flex-shrink-0">
              ...
              <Link
                to="/login"
                className="hidden sm:inline-flex items-center space-x-1.5 px-3.5 py-2 bg-blue-900 hover:bg-blue-800 text-white text-xs font-bold rounded-xl shadow-md hover:shadow-lg transition whitespace-nowrap"
              >
        ...
        {mobileMenuOpen && (
          <div className="2xl:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 px-4 sm:px-6 pt-3 pb-6 shadow-2xl space-y-3 z-50 animate-in slide-in-from-top-2 duration-200">
            <nav className="max-w-md mx-auto flex flex-col space-y-1 text-sm font-bold text-slate-700">
              <button
                onClick={() => scrollToSection('#hero')}
                className="text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 hover:text-blue-900 flex items-center justify-between w-full"
              >
                <span>Home</span>
            ...
            <div className="max-w-md mx-auto pt-3 border-t border-slate-200 flex flex-col sm:hidden space-y-2">
              ...
              <Link
                to="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full py-3 px-4 text-center bg-blue-900 text-white text-xs font-bold rounded-xl shadow flex items-center justify-center space-x-2"
              >
                <span>Access Platform</span>
      ...
      <section id="hero" className="relative pt-12 pb-20 lg:pt-20 lg:pb-28 overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100 border-b border-slate-200 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-900 text-xs font-bold shadow-sm">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight uppercase leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-700">
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-3.5">
              <a
                href="#how-it-works"
                className="px-6 py-3.5 bg-blue-900 hover:bg-blue-800 text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center space-x-2"
              >
              ...
              <Link
                to="/verify-certificate"
                className="px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 text-sm font-bold rounded-xl shadow-sm hover:shadow transition flex items-center space-x-2"
              >
                <Award className="w-4 h-4 text-amber-600" />
                <span>Verify Certificate</span>
              </Link>
              ...
              <Link
                to="/login"
                className="px-6 py-3.5 bg-emerald-700 hover:bg-emerald-800 text-white text-sm font-bold rounded-xl shadow-md transition flex items-center space-x-2"
              >
          ...
          <div className="mt-16 bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-slate-200 relative">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 relative">
              {[
                ...
                return (
                  <div
                    key={idx}
                    className={`p-4 rounded-xl border ${step.color} shadow-sm flex flex-col justify-between relative group hover:scale-105 transition-transform`}
                  >
                    <div>
      ...
      <section id="problem" className="py-16 lg:py-24 bg-white border-b border-slate-200 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            <span className="text-xs font-black uppercase tracking-wider text-red-600 bg-red-50 px-2.5 py-1 rounded border border-red-200">
              The State Challenge
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div key={i} className="p-6 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm hover:border-slate-300 transition">
                  ...
                  <h4 className="text-xs font-bold text-blue-900 mt-1">{card.subtitle}</h4>
      ...
      <section id="solution" className="py-16 lg:py-24 bg-slate-900 text-white border-b border-slate-800 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-black uppercase tracking-wider text-amber-400 bg-amber-950/60 px-3 py-1 rounded border border-amber-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="p-5 bg-slate-800/80 border border-slate-700 rounded-xl hover:border-blue-500 transition relative">
      ...
      <section id="how-it-works" className="py-16 lg:py-24 bg-slate-50 border-b border-slate-200 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            <span className="text-xs font-black uppercase tracking-wider text-blue-900 bg-blue-100 px-2.5 py-1 rounded border border-blue-200">
              System Workflow
            </span>
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight mt-3 uppercase">
                ...
                <div key={idx} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-xs font-extrabold text-blue-900 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">
                        {s.step}
                      </span>
      ...
      <section id="ecosystem" className="py-16 lg:py-24 bg-white border-b border-slate-200 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="text-xs font-black uppercase tracking-wider text-emerald-800 bg-emerald-50 px-3 py-1 rounded border border-emerald-200">
              Integrated Personas
            </span>
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight mt-3 uppercase">
              ...
              return (
                <div key={idx} className={`p-6 rounded-2xl border ${item.color} shadow-sm`}>
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="p-2.5 bg-white text-slate-800 rounded-xl shadow-sm border border-slate-200">
                      <Icon className="w-5 h-5" />
                    </div>
                    <div>
      ...
      <section id="intelligence" className="py-16 lg:py-24 bg-slate-900 text-white border-b border-slate-800 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            <span className="text-xs font-black uppercase tracking-wider text-indigo-400 bg-indigo-950 px-3 py-1 rounded border border-indigo-800">
              AI & Data Science
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              const Icon = card.icon;
              return (
                <div key={i} className="p-6 bg-slate-800 border border-slate-700 rounded-2xl shadow-sm">
                  <div className="p-2.5 bg-slate-700 text-indigo-300 rounded-xl inline-block mb-3">
                    <Icon className="w-5 h-5" />
                  </div>
          ...
          <div className="mt-10 p-4 bg-slate-800/60 border border-slate-700 rounded-xl text-center">
      ...
      <section className="py-16 lg:py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="text-xs font-black uppercase tracking-wider text-blue-900 bg-blue-50 px-3 py-1 rounded border border-blue-200">
              Paradigm Shift
            </span>
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight mt-3 uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Before */}
            <div className="p-8 bg-red-50/40 border border-red-200 rounded-2xl space-y-4">
              <div className="flex items-center space-x-2">
                <span className="px-2.5 py-1 bg-red-100 text-red-800 text-xs font-bold rounded">
                  TRADITIONAL / BEFORE
                </span>
              </div>
              <h3 className="text-lg font-black text-red-950">Fragmented & Unverified Reporting</h3>
              <ul className="space-y-2.5 text-xs text-red-900">
            ...
            {/* After */}
            <div className="p-8 bg-emerald-50/40 border border-emerald-200 rounded-2xl space-y-4">
              <div className="flex items-center space-x-2">
            ...
            {[
              ...
              return (
                <div key={i} className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm">
                  <div className="p-2.5 bg-blue-50 text-blue-900 rounded-xl inline-block mb-3">
                    <Icon className="w-5 h-5" />
                  </div>
      ...
      <section className="py-14 bg-blue-950 text-white border-b border-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Registered Learners</p>
              <p className="text-2xl sm:text-3xl font-black text-white mt-1">{metrics.registeredLearners}</p>
            </div>
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Accredited Courses</p>
              <p className="text-2xl sm:text-3xl font-black text-white mt-1">{metrics.accreditedCourses}</p>
            </div>
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Active Batches</p>
              <p className="text-2xl sm:text-3xl font-black text-white mt-1">{metrics.activeBatches}</p>
            </div>
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Training Providers</p>
              <p className="text-2xl sm:text-3xl font-black text-white mt-1">{metrics.trainingProviders}</p>
            </div>
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Districts Covered</p>
              <p className="text-2xl sm:text-3xl font-black text-white mt-1">{metrics.districtsCovered}</p>
            </div>
            <div className="p-4 bg-blue-900/60 border border-blue-800 rounded-xl">
              <p className="text-xs text-blue-300 font-semibold uppercase">Verified Placements</p>
      ...
      <section className="py-16 lg:py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-10">
            <span className="text-xs font-black uppercase tracking-wider text-amber-800 bg-amber-50 px-2.5 py-1 rounded border border-amber-200">
      ...
      <section className="py-16 lg:py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-xs font-black uppercase tracking-wider text-purple-900 bg-purple-100 px-3 py-1 rounded border border-purple-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-center">
              <span className="text-xs font-black text-blue-900">MILESTONE 1</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-3xl p-8 sm:p-12 text-white shadow-xl relative overflow-hidden">
            <div className="max-w-2xl">
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-md bg-amber-400/20 text-amber-300 text-xs font-bold mb-4">
              ...
              <form onSubmit={handleQuickVerify} className="mt-6 flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white text-slate-900 font-mono text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 uppercase"
                />
                <button
                  type="submit"
                  className="px-6 py-3 bg-amber-400 hover:bg-amber-300 text-slate-950 font-extrabold text-sm rounded-xl shadow-md transition flex items-center justify-center space-x-2"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            <div className="space-y-1">
              <Lock className="w-6 h-6 text-blue-900 mx-auto" />
      ...
      <section className="py-20 bg-gradient-to-b from-white to-slate-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <span className="text-xs font-black uppercase tracking-widest text-blue-900 bg-blue-50 px-3 py-1 rounded border border-blue-200">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/login"
              className="px-8 py-4 bg-blue-900 hover:bg-blue-800 text-white text-sm font-bold rounded-xl shadow-xl hover:shadow-2xl transition flex items-center space-x-2"
            >
              <span>Access Platform</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
            ...
            <Link
              to="/verify-certificate"
              className="px-8 py-4 bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 text-sm font-bold rounded-xl shadow-md transition flex items-center space-x-2"
            >
              <Award className="w-4 h-4 text-amber-600" />
              <span>Verify Certificate</span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-slate-800">
            ...
            <div>
              ...
              <ul className="space-y-1.5">
                ...
                <li><Link to="/verify-certificate" className="hover:text-white">Public Certificate Verification</Link></li>
                <li><Link to="/login" className="hover:text-white">Learner Registration</Link></li>
                <li><Link to="/login" className="hover:text-white">Employer Registration</Link></li>
              </ul>
            </div>
